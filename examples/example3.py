...
# buf1_1 = bytearray(hres*vres*lv.color_t.SIZE)
# buf1_2 = bytearray(hres*vres*lv.color_t.SIZE)
buf1_1 = lcd.bytearray(hres * 10 * lv.color_t.SIZE)
buf1_2 = lcd.bytearray(hres * 10 * lv.color_t.SIZE)
